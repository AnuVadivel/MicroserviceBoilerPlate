...
using Payment.ComponentTests.SetUp;
using Xunit;
using Xunit.Abstractions;

namespace Payment.ComponentTests
{
    public class PaymentComponentTests : BaseTest, IClassFixture<TestSuiteFixture>
    {
        public PaymentComponentTests(TestSuiteFixture fixture, ITestOutputHelper output)
            : base(
        ...
        /// --> [MemberData(nameof(GetTestCases), "payment.json")]
